(() => {
  'use strict';
  const BUILD_ID='20260824-15',LEGAL='Türkiye Yüzyılı Maarif Modeli dikkate alınmıştır.';
  window.LGS_ARENA_CONFIG=Object.freeze({
    schemaVersion:11,appVersion:'7.0.0-detailed-notes',buildId:BUILD_ID,season:2027,appName:'LGS 2027 Arena',coverLocked:true,
    coverStandard:'LGS2027-ZEUS-ARENA-COVER-2026-08-23-V630-20260824-15',coverAsset:'assets/zeus-hero-20260823-02.webp?v='+BUILD_ID,
  ...
  const core=document.createElement('link');core.rel='stylesheet';core.href='./visual-core-v5.css?v='+BUILD_ID;core.dataset.arenaVisualCore='7.0.0';document.head.appendChild(core);
  const layout=document.createElement('link');layout.rel='stylesheet';layout.href='./layout-v52.css?v='+BUILD_ID;layout.dataset.arenaLayout='7.0.0';document.head.appendChild(layout);
