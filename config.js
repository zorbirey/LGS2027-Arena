(() => {
  'use strict';
  const BUILD_ID='20260824-18',LEGAL='Türkiye Yüzyılı Maarif Modeli dikkate alınmıştır.';
  window.LGS_ARENA_CONFIG=Object.freeze({
    schemaVersion:11,appVersion:'7.3.0-adaptive-question-types',buildId:BUILD_ID,season:2027,appName:'LGS 2027 Arena',coverLocked:true,
    coverStandard:'LGS2027-ZEUS-ARENA-COVER-2026-08-23-V630-20260824-18',coverAsset:'assets/zeus-hero-20260823-02.webp?v='+BUILD_ID,
