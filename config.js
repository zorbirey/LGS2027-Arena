(() => {
  ...
  window.LGS_ARENA_CONFIG = Object.freeze({
    schemaVersion: 10,
    appVersion: '5.2.5-arena-icon',
    buildId: '20260823-03',
    season: 2027,
    appName: 'LGS 2027 Arena',
    coverLocked: true,
    coverStandard: 'LGS2027-ZEUS-ARENA-COVER-2026-08-23-V525-20260823-03',
    coverAsset: 'assets/zeus-hero-20260823-02.webp?v=5.2.5',
  ...
  core.rel='stylesheet';
  core.href='./visual-core-v5.css?v=5.2.5';
  core.dataset.arenaVisualCore='5.2.5';
  document.head.appendChild(core);
  const layout=document.createElement('link');
  layout.rel='stylesheet';
  layout.href='./layout-v52.css?v=5.2.5';
  layout.dataset.arenaLayout='5.2.5';
