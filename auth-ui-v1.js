(()=>{
  ...
  const friendlyError=error=>{
    ...
    if(code.startsWith('E-posta')||code.startsWith('Parolanız'))return code;
  ...
  function credentials(){
    ...
    if(password.length<12)throw new Error('Parolanız en az 12 karakter olmalıdır.');
