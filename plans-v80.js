(() => {
  ...
  async function exportBackup(){
    ...
    const payload=JSON.stringify(data),file={format:'LGS_ARENA_DEVICE_TRANSFER',schema:1,createdAt:new Date().toISOString(),buildId:'20260824-22',automaticSync:false,data,checksum:await checksum(payload)};
