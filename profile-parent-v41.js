(() => {
  ...
  function premium(){const state=readState(),until=Date.parse(state.freePremiumUntil||'');return !!state.isPremium||(Number.isFinite(until)&&until>Date.now())}
